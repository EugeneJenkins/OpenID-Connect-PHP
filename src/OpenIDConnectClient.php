...
class OpenIDConnectClient
{
    ...
    /**
     * It notifies that the client wants to logout
     *
     * @throws OpenIDConnectClientException
     */
    public function logOut()
    {
        ...
        $logout_endpoint = $this->getProviderConfigValue('logout_endpoint');

        $headers = [];

        // Convert token params to string format
        $post_params = http_build_query($params, '', '&', $this->encType);

        return json_decode($this->fetchURL($logout_endpoint, $post_params, $headers));
    }
